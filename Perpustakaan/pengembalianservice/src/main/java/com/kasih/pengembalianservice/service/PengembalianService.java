package com.kasih.pengembalianservice.service;
...
import com.kasih.pengembalianservice.repository.PengembalianRepository;
import com.kasih.pengembalianservice.vo.Anggota;
import com.kasih.pengembalianservice.vo.Buku;
import com.kasih.pengembalianservice.vo.Peminjaman;
...
public class PengembalianService {
    ...
    public Pengembalian createPengembalian(Pengembalian pengembalian) throws ParseException {
        ...
        String tglDikembalikanStr = pengembalian.getTanggalDikembalikan().toString(); 
        Date tanggalDikembalikan = sdf.parse(tglDikembalikanStr);

        String tglKembaliStr = peminjaman.getTanggalKembali();
        Date tanggalKembali = sdf.parse(tglKembaliStr);
