package com.kasih.rabbitmq_pustaka;
...
import com.kasih.rabbitmq_pustaka.vo.Anggota;
import com.kasih.rabbitmq_pustaka.vo.Peminjaman;
import com.kasih.rabbitmq_pustaka.vo.ResponseTemplate;
...
public class PeminjamanConsumerService {
    ...
    public void receiveOrder(@Payload Peminjaman peminjaman) {
        ...
        try {
            ...
            ResponseTemplate[] response = restTemplate.getForObject(
                    serviceInstance.getUri() + "/api/peminjaman/" + peminjaman.getId() + "/detail",
